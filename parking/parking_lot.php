...
if ( isJson( $data ) ) 
 {
    ...
    if ( $parking_id  == 0  )
    {
        ...
        $query = "INSERT INTO parking_lot ( parking_name, user_msisdn, user_id, number_of_blocks, is_slot_available, address, lat_v, long_val, location_lat_value, 
        ...
        VALUES( '$p_name', '$msisdn', '$userid', '$blocks', '$slot', '$address', '$lat_v', '$long_value', '$location_lat', '$location_long', '$opr_night', '$min_pay',  '$monthly_passed', 
